...
As Lakhesis analysis uses simulation to derive a consensus seriation, it is recommended that one check for the potential of an even more optimal consensus seriation by running the `lakhesize()` function using the method `"optimize"`, especially if there are a high number of `strands`:
