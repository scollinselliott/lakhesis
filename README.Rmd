...
* **Consensus Seriation** (Top right) Displays the results of harmonizing selected partial seriations, which have been identified as "strands." The process of deriving a consensus seriation entails a process of iterative regressions on partially seriated sequences, optimzed using the concentration measure. The seriated incidence matrix is also displayed in this panel.
...
Console fuctions can also be used to perform consensus serations. For example, using the built-in selection of three strands in the data object `qfStrands`, a consensus seration is performed using the `lakhesize()` function:
